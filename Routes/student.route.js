...
const { studentsignup, studentlogin, getstudentsignup, getstudentlogin, studentdash, getData , updaterId, getallstudents, payments } = require("../Controller/student.controller")
...
router.post('/student/payment', payments)
